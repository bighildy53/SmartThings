...
private def textHelp() {
	def text =
		...
		"Finally, within one of the six scenarios of this app, define switch to be used and tie the on/off state of that switch to a specific routine, mode or the on/off state of other switches. "+
		"The routine, mode or switches will fire with the switch state changes, except in cases where you have a delay specified. This time delay is optional and only available in the first four scenarios. "+
